<?php
require_once 'C:\xampp\htdocs\CSE485_2023\BTTH02\controller\LoginController.php';
        ...
        <div class="card shadow-lg ">
          ...
          <div class="card-body mt-5">
            <form method="POST">
              ...
              <button type="submit" class="btn btn-primary btn-block mt-4" name="btnLogin">Submit</button>
            </form>
            =======
